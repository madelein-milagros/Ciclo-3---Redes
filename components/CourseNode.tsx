  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Marcador de Estación - Más pequeño en móviles */}
        <div 
          className={`relative w-8 h-8 md:w-14 md:h-14 rounded-lg md:rounded-2xl flex items-center justify-center transition-all duration-500 shadow-md md:shadow-xl border-2 md:border-4
        ...
        {/* Etiqueta Oculta en móviles muy pequeños para limpiar la vista */}
        <div 
          className={`hidden md:block absolute -bottom-10 whitespace-nowrap px-3 py-1 rounded-md text-[9px] font-black uppercase tracking-widest transition-all duration-300 pointer-events-none
            ${isActive 
